...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.indigo-button','data' => ['wire:click' => '$dispatch(\'create-modal\')','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$dispatch(\'create-modal\')','wire:loading.attr' => 'disabled']); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/mohammed/Desktop/projects/laravels/system-engineering-mff/resources/views/components/create-button.blade.php ENDPATH**/ ?>