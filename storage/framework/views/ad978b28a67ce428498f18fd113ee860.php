...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('import-shop-damietta-only')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-damietta-only.import-shop-damietta-only', []);
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1217790814-5', $__slots ?? [], get_defined_vars());
