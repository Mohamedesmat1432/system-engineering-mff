...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'email','class' => 'block mt-1 w-full','type' => 'email','name' => 'email','placeholder' => ''.e(__('site.email')).'','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('email')),'required' => true,'autofocus' => true,'autocomplete' => 'username']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                <div class="relative">
                    <?php if (isset($component)) { $__componentOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['id' => 'password','class' => 'block mt-1 w-full',':type' => 'showPassword ? \'text\' : \'password\'','name' => 'password','required' => true,'placeholder' => ''.e(__('site.password')).'','autocomplete' => 'current-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'password','class' => 'block mt-1 w-full',':type' => 'showPassword ? \'text\' : \'password\'','name' => 'password','required' => true,'placeholder' => ''.e(__('site.password')).'','autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1)): ?>
<?php $attributes = $__attributesOriginalc2fcfa88dc54fee60e0757a7e0572df1; ?>
...
<?php endif; ?>
                    <span class="mx-2 text-sm text-gray-600"><?php echo e(__('site.remember_me')); ?></span>
                </label>
                ...
                <?php if(Route::has('register')): ?>
                    <a wire:navigate
                        ...
                        <?php echo e(__('site.i_dont_have_account')); ?>
            ...
            <div class="flex items-center justify-between mt-4">
                <?php if(Route::has('password.request')): ?>
                    <a wire:navigate
                        ...
                        <?php echo e(__('site.forgot_your_password')); ?>

                    </a>
                <?php endif; ?>

                <?php if (isset($component)) { $__componentOriginalb1002aa4cd2764fbb7d078bdc8760235 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb1002aa4cd2764fbb7d078bdc8760235 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-indigo-button','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('auth-indigo-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
...
<?php $component->withAttributes([]); ?>
                 ...
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalb1002aa4cd2764fbb7d078bdc8760235)): ?>
<?php $attributes = $__attributesOriginalb1002aa4cd2764fbb7d078bdc8760235; ?>
<?php unset($__attributesOriginalb1002aa4cd2764fbb7d078bdc8760235); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalb1002aa4cd2764fbb7d078bdc8760235)): ?>
<?php $component = $__componentOriginalb1002aa4cd2764fbb7d078bdc8760235; ?>
<?php unset($__componentOriginalb1002aa4cd2764fbb7d078bdc8760235); ?>
<?php endif; ?>
            </div>
        </form>
     <?php echo $__env->renderComponent(); ?>
...
<?php endif; ?>
<?php /**PATH /home/mohammed/Desktop/projects/laravels/system-engineering-mff/resources/views/auth/login.blade.php ENDPATH**/ ?>