...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.page-content','data' => ['pageName' => ''.e(__('site.list_shop_outside_damietta')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['page-name' => ''.e(__('site.list_shop_outside_damietta')).'']); ?>

        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.create-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-0', $__slots ?? [], get_defined_vars());
...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.update-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-1', $__slots ?? [], get_defined_vars());
...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.delete-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-2', $__slots ?? [], get_defined_vars());
...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('bulk-delete-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.bulk-delete-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-3', $__slots ?? [], get_defined_vars());
...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('import-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.import-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-4', $__slots ?? [], get_defined_vars());
...
?>
        <?php endif; ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('export-shop-outside-damietta')): ?>
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('shop-outside-damietta.export-shop-outside-damietta', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-2743084562-5', $__slots ?? [], get_defined_vars());
        ...
        <div class="p-6 lg:p-8 bg-white border-b border-gray-200 rounded-md">
            ...
            <div class="flex justify-between">
                <h1 class=" text-2xl font-medium text-gray-900 underline">
                    <?php echo e(__('site.list_shop_outside_damietta')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.create-button','data' => ['permission' => 'create-shop-outside-damietta']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'create-shop-outside-damietta']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.import-button','data' => ['permission' => 'import-shop-outside-damietta']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'import-shop-outside-damietta']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.export-button','data' => ['permission' => 'export-shop-outside-damietta']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'export-shop-outside-damietta']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.edit-button','data' => ['permission' => 'edit-shop-outside-damietta','id' => ''.e($shop->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'edit-shop-outside-damietta','id' => ''.e($shop->id).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-button','data' => ['permission' => 'delete-shop-outside-damietta','id' => ''.e($shop->id).'','name' => ''.e($shop->national_number).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'delete-shop-outside-damietta','id' => ''.e($shop->id).'','name' => ''.e($shop->national_number).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
</div><?php /**PATH /home/mohammed/Desktop/projects/laravels/system-engineering-mff/resources/views/livewire/shop-outside-damietta/list-shop-outside-damietta.blade.php ENDPATH**/ ?>