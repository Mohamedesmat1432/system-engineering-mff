...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.indigo-button','data' => ['wire:click' => '$dispatch(\'import-modal\')','wire:loading.attr' => 'disabled']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => '$dispatch(\'import-modal\')','wire:loading.attr' => 'disabled']); ?>
...
<?php $component = WireUi\Heroicons\Icon::resolve(['name' => 'arrow-up'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php unset($__componentOriginal7fa57d00c29530b074487861a28c29f3); ?>
<?php endif; ?>
<?php endif; ?><?php /**PATH /home/mohammed/Desktop/projects/laravels/system-engineering-mff/resources/views/components/import-button.blade.php ENDPATH**/ ?>