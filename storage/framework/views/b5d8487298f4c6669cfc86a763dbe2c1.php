...
$__html = app('livewire')->mount($__name, $__params, 'lw-2919848470-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2919848470-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2919848470-2', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2919848470-3', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
                                ...
                                <td class="p-2 border">
                                    <?php echo e(app()->getLocale() === 'ar' ? $department->name_ar : $department->name_en); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-button','data' => ['permission' => 'delete-department','id' => ''.e($department->id).'','name' => ''.e(app()->getLocale() === 'ar' ? $department->name_ar : $department->name_en).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permission' => 'delete-department','id' => ''.e($department->id).'','name' => ''.e(app()->getLocale() === 'ar' ? $department->name_ar : $department->name_en).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH /home/mohammed/Desktop/projects/laravels/system-engineering-mff/resources/views/livewire/department/list-department.blade.php ENDPATH**/ ?>