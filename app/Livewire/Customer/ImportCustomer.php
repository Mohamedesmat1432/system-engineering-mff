...
{
    use CustomerTrait, WithFileUploads;
    ...
    public function import(CustomersImport $import)
    {
        ...
        try {
            ...
            $this->successNotify(__('site.customer_imported'));
    ...
    {
        $this->authorize('import-customer');
